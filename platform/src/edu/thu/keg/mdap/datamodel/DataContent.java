...
/**
 * Data Object, who gives access to actual data from data providers.
 * It is used for fetching and writing data to data providers.
 * It gives access to data in a streaming style.
 * @author Yuanchao Ma
 *
 */
public interface DataContent {
	 ...
	 * @throws DataProviderException When data provider gives a error.
	 */
	 ...
	 * @param field The DataField whose value is expected
	 * @return The value
	 * @throws DataProviderException When data provider gives a error, or the field 
	 * does not exist in this DataContent.
	 */
